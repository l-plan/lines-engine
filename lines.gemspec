...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency 'thor', '>= 1.0.0'
  s.add_runtime_dependency 'carrierwave', '>= 1.2.0'
  s.add_runtime_dependency 'kaminari', '>= 0.2.0'
  s.add_runtime_dependency 'pygments.rb', '>= 1.2.1'
  s.add_runtime_dependency 'redcarpet', '>= 3.5.0'
  s.add_runtime_dependency 'jquery-rails', '< 6', '>= 3.1.0'
  s.add_runtime_dependency 'acts-as-taggable-on', '>= 6.5.0'
  s.add_runtime_dependency 'bcrypt', '~> 3.1.0', '>= 3.1.0'
  s.add_runtime_dependency 'sitemap_generator', '>= 6.0.0'
