...
- kaminari-view: nav class 'pagination' now is '_pagination_', since it is not used by lines, but other apps do...
- the root directory for uploads has moved to the config-file
